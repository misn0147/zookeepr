...
const app = express();
//both apps below need to be set up any time you create a server that's looking to accept POST data 
...
function filterByQuery(query, animalsArray) {
    ...
    if (query.personalityTraits) {
        ...
        personalityTraitsArray.forEach(trait => {
            // Check teh trait against each animal in the filteredResults array.
            // Remember, it is initially a copy of the animalsArray, but here we're updating it fore each trait in the .forEach() loop.
